...
describe('InventoryManagerService', () => {
  ...
  describe('addItem', () => {
    ...
    it('should add a single item to empty inventory', async () => {
      const result = await service.addItem('player1', 'sword', 1, {
        weight: 10,
      });
    ...
    it('should add multiple items at once', async () => {
      const result = await service.addItem('player1', 'potion', 5, {
        weight: 1,
      });
    ...
    it('should stack items when allowStacking is enabled', async () => {
      await service.addItem('player1', 'potion', 3, {
        weight: 1,
        maxStack: 99,
      });
      const result = await service.addItem('player1', 'potion', 2, {
        weight: 1,
        maxStack: 99,
      });
    ...
    it('should create new stack when max stack size is reached', async () => {
      await service.addItem('player1', 'potion', 99, {
        weight: 1,
        maxStack: 99,
      });
      const result = await service.addItem('player1', 'potion', 5, {
    ...
    it('should fail when inventory is full (slot limit)', async () => {
      ...
      const result = await service.addItem('player2', 'item3', 1, {
        weight: 1,
        maxStack: 1,
      });
    ...
    it('should fail when weight limit is exceeded', async () => {
      ...
      const result = await service.addItem('player2', 'another_item', 1, {
        weight: 30,
      });
    ...
    it('should not stack equipped items', async () => {
      ...
      const result = await service.addItem('player2', 'sword', 1, {
        weight: 10,
      });
    ...
    it('should handle partial stacking when space is limited', async () => {
      await service.addItem('player1', 'arrow', 95, {
        weight: 1,
        maxStack: 99,
      });
      const result = await service.addItem('player1', 'arrow', 10, {
        weight: 1,
        maxStack: 99,
      });
  ...
  describe('removeItem', () => {
    ...
    beforeEach(async () => {
      ...
      const result = await service.addItem('player1', 'sword', 5, {
        weight: 10,
      });
    ...
    it('should handle items with explicit weight of 0', async () => {
      ...
      const result = await service.addItem('player1', 'weightless', 5, {
        weight: 0,
      });
      ...
      const weightlessItem = inventory?.items.find(
        (item) => item.instanceId === weightlessId,
      );
  ...
  describe('equipItem', () => {
    ...
    it('should update equippedItems map', async () => {
      ...
      const inventory = service.getInventory('player1');
      const equippedItem = inventory?.equippedItems.get(
        EquipmentSlot.MAIN_HAND,
      );
    ...
    it('should unequip existing item when equipping to same slot', async () => {
      const result1 = await service.addItem('player1', 'old_sword', 1, {
        weight: 10,
      });
      ...
      const oldSword = inventory?.items.find(
        (item) => item.instanceId === oldSwordId,
      );
      const newSword = inventory?.items.find(
    ...
    it('should fail when equipment is not allowed', async () => {
      ...
      const equipResult = await service.equipItem(
        'player2',
        swordId,
        EquipmentSlot.MAIN_HAND,
      );
      ...
      expect(equipResult.message).toBe(
        'Equipment not allowed in this inventory',
      );
    });
    ...
    it('should fail when equipment slot is not available', async () => {
      ...
      expect(equipResult.success).toBe(false);
      expect(equipResult.message).toContain(
        'Equipment slot main_hand not available',
      );
    });
    ...
    it('should handle multiple equipment slots', async () => {
      const helmetResult = await service.addItem('player1', 'helmet', 1, {
        weight: 5,
      });
  ...
  describe('transferItem', () => {
    ...
    it('should fail when trying to transfer equipped item', async () => {
      ...
      const result = await service.addItem('player3', 'sword', 1, {
        weight: 10,
      });
      const swordId = result.item?.instanceId!;
      ...
      const transferResult = await service.transferItem(
        'player3',
        'player4',
        swordId,
        1,
    ...
    it('should fail when destination is full', async () => {
      ...
      await service.addItem('player3', 'existing_item', 1, {
        weight: 5,
        maxStack: 1,
      });

      const result = await service.addItem('player1', 'new_item', 1, {
        weight: 5,
        maxStack: 1,
      });
    ...
    it('should fail when destination weight limit is exceeded', async () => {
      ...
      const result = await service.addItem('player1', 'another_heavy', 1, {
        weight: 20,
      });
    ...
    it('should preserve item metadata during transfer', async () => {
      ...
      const player2Inv = service.getInventory('player2');
      const transferredItem = player2Inv?.items.find(
        (item) => item.itemId === 'magic_sword',
      );
  ...
  describe('Edge Cases and Complex Scenarios', () => {
    it('should handle inventory at exact weight capacity', async () => {
      ...
      const result = await service.addItem('player1', 'item', 1, {
        weight: 100,
      });
    ...
    it('should handle multiple equipment slots correctly', async () => {
      ...
      for (let i = 0; i < slots.length; i++) {
        const result = await service.addItem('player1', `item_${i}`, 1, {
          weight: 1,
        });
    ...
    it('should handle stacking with different max stack sizes', async () => {
      ...
      await service.addItem('player1', 'potion', 50, {
        weight: 1,
        maxStack: 50,
      });
      const result = await service.addItem('player1', 'potion', 30, {
        weight: 1,
        maxStack: 50,
      });
    ...
    it('should maintain inventory consistency after failed operations', async () => {
      ...
      const result1 = await service.addItem('player1', 'item1', 1, {
        weight: 50,
      });
    ...
    it('should handle transfer with stacking enabled', async () => {
      ...
      await service.addItem('player2', 'potion', 30, {
        weight: 1,
        maxStack: 99,
      });

      const result = await service.addItem('player1', 'potion', 20, {
        weight: 1,
        maxStack: 99,
      });
  ...
  describe('EXPLOIT PREVENTION: Item Duplication', () => {
    ...
    it('should prevent item duplication during transfer by maintaining unique instanceId', async () => {
      const result = await service.addItem('player1', 'rare_sword', 1, {
        weight: 10,
      });
      ...
      expect(
        player1Inv?.items.find((i) => i.instanceId === originalInstanceId),
      ).toBeUndefined();
      // Player2 should have the item (may have different instanceId due to stacking)
      expect(
        player2Inv?.items.find((i) => i.itemId === 'rare_sword'),
      ).toBeDefined();
      // Total quantity should still be 1
      const totalQuantity =
        (player1Inv?.items
          .filter((i) => i.itemId === 'rare_sword')
    ...
    it('should not duplicate items on failed transfer rollback', async () => {
      ...
      await service.addItem('player3', 'existing', 1, {
        weight: 5,
        maxStack: 1,
      });

      const result = await service.addItem('player1', 'sword', 2, {
        weight: 10,
      });
      const swordId = result.item?.instanceId!;
    ...
    it('should prevent stack duplication when splitting stacks', async () => {
      const result = await service.addItem('player1', 'arrow', 100, {
        weight: 1,
        maxStack: 99,
      });
    ...
    it('should maintain correct weight after partial stack transfer', async () => {
      const result = await service.addItem('player1', 'gold', 1000, {
        weight: 0.1,
        maxStack: 9999,
      });
      const goldId = result.item?.instanceId!;

      const player1WeightBefore =
        service.getInventory('player1')?.currentWeight || 0;

      await service.transferItem('player1', 'player2', goldId, 500);

      const player1WeightAfter =
        service.getInventory('player1')?.currentWeight || 0;
      ...
      expect(player1WeightBefore).toBeCloseTo(
        player1WeightAfter + player2Weight,
        1,
      );
    });

    it('should prevent duplication through rapid consecutive transfers', async () => {
      const result = await service.addItem('player1', 'coin', 100, {
        weight: 1,
      });
      ...
      const player1Inv = service.getInventory('player1');
      const remainingCoinId = player1Inv?.items.find(
        (i) => i.itemId === 'coin',
      )?.instanceId;
  ...
  describe('EXPLOIT PREVENTION: Overflow and Underflow', () => {
    ...
    it('should reject negative quantity when adding items', async () => {
      const result = await service.addItem('player1', 'item', -5, {
        weight: 1,
      });
    ...
    it('should reject negative quantity when removing items', async () => {
      const result = await service.addItem('player1', 'item', 10, {
        weight: 1,
      });
      const itemId = result.item?.instanceId!;
    ...
    it('should handle extremely large quantities safely (MAX_SAFE_INTEGER)', async () => {
      ...
      const result = await service.addItem('player1', 'item', maxSafe, {
        weight: 1,
      });
    ...
    it('should prevent weight overflow with large values', async () => {
      const result = await service.addItem('player1', 'heavy', 1, {
    ...
    it('should prevent quantity overflow when stacking', async () => {
      await service.addItem('player1', 'item', Number.MAX_SAFE_INTEGER - 10, {
        weight: 1,
        maxStack: Number.MAX_SAFE_INTEGER,
      });

      const result = await service.addItem('player1', 'item', 100, {
        weight: 1,
        maxStack: Number.MAX_SAFE_INTEGER,
      });
    ...
    it('should handle NaN quantity gracefully', async () => {
      const result = await service.addItem('player1', 'item', NaN, {
        weight: 1,
      });
    ...
    it('should handle Infinity quantity gracefully', async () => {
      const result = await service.addItem('player1', 'item', Infinity, {
        weight: 1,
      });
  ...
  describe('EXPLOIT PREVENTION: Inventory State Corruption', () => {
    ...
    it('should handle equipped item removal gracefully', async () => {
      ...
      const equippedSword = inventory?.equippedItems.get(
        EquipmentSlot.MAIN_HAND,
      );
      ...
      expect(
        inventory?.items.find((i) => i.instanceId === swordId),
      ).toBeUndefined(); // Item is gone
    });

    it('should detect orphaned equipped items', async () => {
      const result = await service.addItem('player1', 'helmet', 1, {
        weight: 5,
      });
      ...
      const actualHelmet = inventory?.items.find(
        (i) => i.instanceId === helmetId,
      );
    ...
    it('should maintain equippedItems map consistency when transferring equipped items fails', async () => {
      ...
      expect(
        inventory?.items.find((i) => i.instanceId === swordId)?.equipped,
      ).toBe(true);
    });
  ...
  describe('EXPLOIT PREVENTION: Equipment Exploits', () => {
    ...
    it('should prevent equipping same item type to same slot twice', async () => {
      const result1 = await service.addItem('player1', 'sword', 1, {
        weight: 10,
      });
      const result2 = await service.addItem('player1', 'sword', 1, {
        weight: 10,
      });
      ...
      const newEquipped = updatedInv?.equippedItems.get(
        EquipmentSlot.MAIN_HAND,
      );
    ...
    it('should maintain equipment state through inventory operations', async () => {
      const result1 = await service.addItem('player1', 'sword', 2, {
        weight: 10,
        maxStack: 99,
      });
      ...
      const inventory = service.getInventory('player1');
      expect(
        inventory?.items.find((i) => i.instanceId === swordId)?.quantity,
      ).toBe(2);
    });
    ...
    it('should prevent stat bonus stacking from multiple equips', async () => {
      ...
      const inventory = service.getInventory('player1');
      const equippedCount = Array.from(
        inventory?.equippedItems.values() || [],
    ...
    it('should handle equipping without meeting slot requirements', async () => {
      ...
      const result = await service.addItem('player2', 'boots', 1, {
        weight: 3,
      });
  ...
  describe('EXPLOIT PREVENTION: Transfer and Trade Exploits', () => {
    ...
    it('should prevent transferring more items than exist', async () => {
      const result = await service.addItem('player1', 'coin', 50, {
        weight: 1,
      });
      const coinId = result.item?.instanceId!;
    ...
    it('should handle transfer of entire stack correctly', async () => {
      const result = await service.addItem('player1', 'arrow', 99, {
        weight: 1,
        maxStack: 99,
      });
      ...
      expect(
        player1Inv?.items.find((i) => i.itemId === 'arrow'),
      ).toBeUndefined();
      expect(
        player2Inv?.items.find((i) => i.itemId === 'arrow')?.quantity,
      ).toBe(99);
    });
    ...
    it('should preserve item metadata during transfer', async () => {
      ...
      const player2Inv = service.getInventory('player2');
      const transferredSword = player2Inv?.items.find(
        (i) => i.itemId === 'magic_sword',
      );
    ...
    it('should handle transfer between inventories with different stacking settings', async () => {
      ...
      const result = await service.addItem('player1', 'potion', 10, {
        weight: 1,
      });
      ...
      const player3Inv = service.getInventory('player3');
      const potions =
        player3Inv?.items.filter((i) => i.itemId === 'potion') || [];
  ...
  describe('EXPLOIT PREVENTION: Edge Case Validation', () => {
    ...
    it('should maintain instanceId uniqueness across all inventories', async () => {
      ...
      const result1 = await service.addItem('player1', 'item', 1, {
        weight: 1,
        maxStack: 1,
      });
      const result2 = await service.addItem('player1', 'item', 1, {
        weight: 1,
        maxStack: 1,
      });
      const result3 = await service.addItem('player2', 'item', 1, {
        weight: 1,
        maxStack: 1,
      });
    ...
    it('should handle maxStack of 1 (non-stackable items)', async () => {
      await service.addItem('player1', 'unique_sword', 1, {
        weight: 10,
        maxStack: 1,
      });
      await service.addItem('player1', 'unique_sword', 1, {
      ...
      const inventory = service.getInventory('player1');
      const swords =
        inventory?.items.filter((i) => i.itemId === 'unique_sword') || [];
    ...
    it('should handle adding items to inventory at exact limits', async () => {
      ...
      const result = await service.addItem('player2', 'item2', 1, {
        weight: 25,
        maxStack: 1,
      });
      ...
      const failResult = await service.addItem('player2', 'item3', 1, {
        weight: 1,
      });
